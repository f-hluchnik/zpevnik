...
\vers{1}{
\chord{D\2}Jako když k půlnoci na dveře zaklepe \chord{A}nezvaný host,\\
\chord{Em}stejně tak na tebe za rohem čeká \chord{G}tvoje minulost. \chord{A}\\
\chord{D\2}Šaty má tytéž, vlasy má tytéž a \chord{A}boty kožené,\\
\chord{Em}pomalu, kulhavě, za tebou pajdá, \chord{G}až tě dožene \chord{A}a řekne:
}

\refrainn{1}{
\chord{D\2}Tak mě tu máš, \chord{A}tak si mě zvaž,\\
\chord{Em}pozvi mě dál, \chord{A}jestli mě znáš, jsem tvoje \chord{D\2}minulost.
}
