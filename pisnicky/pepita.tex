...
\chord{A}co byla křivě \chord{D}seši\chord{D\sm}tá, \chord{D}je ale \chord{Hm\7}príma, je \chord{Em}pe -\chord{A} pi\chord{D}ta.*
}
...
\fakt{Pepito je tkanina se střídavě světlými a tmavými barevnými efekty ve tvaru drobných kostek, jejichž velikost je dána střídou. Příbuzné vzorování mají tkaniny s tzv. kohoutí stopou a vichy.\\
