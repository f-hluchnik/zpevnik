...
Ay arriba y ar\chord{C}riba por \chord{F}to se\chord{G}re yo no soy mari\chord{C}nero. \chord{F}\nc\chord{G}\\
Yo no soy mari\chord{G}nero soy \chord{F}capi\chord{G}tan soy capi\chord{C}tan soy \chord{F}capi\chord{G}tan.
}
